...
- Reverse engineer or extract the source code of our software
- Use automated tools (bots, scrapers) to extract data from the website
- Impersonate any person or entity

## 7. Disclaimer of Warranties

THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. WE DO NOT GUARANTEE THAT THE READINGS ARE ACCURATE, COMPLETE, OR SUITABLE FOR ANY PARTICULAR PURPOSE. BaZi astrology is a cultural tradition and the interpretations provided are for entertainment purposes.
...
We reserve the right to modify these Terms at any time. Changes will be posted on this page with an updated date. Your continued use of the Service after changes constitutes acceptance of the new Terms.
